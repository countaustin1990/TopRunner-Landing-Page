    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main>
        ...
        <section className="relative px-4 pt-20 pb-24 md:pt-28 md:pb-32 overflow-hidden">
          ...
          <FloatingCard 
            className="absolute -bottom-5 -left-10 md:left-12 z-10 floating-card"
            title="Power keywords"
            content={
              <div className="flex flex-col gap-1"> 
                <div className="bg-purple-100/80 text-purple-800  w-24 h-24 rounded-full text-xs">content marketing</div> 
